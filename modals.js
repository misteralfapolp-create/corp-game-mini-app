...
async function createCompany() {
    try {
        ...
        try {
            ...
            toast('❌ Ошибка авторизации: ' + (tokenError.message || 'неизвестная'), 'error');
            return;
        }
        ...
        try {
            ...
            console.error('Ошибка получения групп:', apiError);
            toast('❌ Ошибка получения групп: ' + (apiError.message || 'неизвестная'), 'error');
            return;
        }
